...
function countdestime() {
       	valueOf(document.getElementById("starttah").value)=valueOf(document.getElementById("starttah").value)+valueOf(document.getElementById("starttam").value/60)+valueOf(document.getElementById("starttas").value/3600);
};
/*
